...
import { SystemStyle } from "../components/settings/SystemStyle";
import { Contribution } from "../components/settings/Contribution";

/** Dashboard Component - Orchestrates the main application view and settings */
        ...
        {activeTab === "home" ? (
          ...
          <div className={styles.settingsContainer}>
            ...
            <div className={styles.settingsContent}>
              {settingsTab === "account" && (
                <AccountSetup 
                  config={config} updateConfig={updateConfig} authMode={authMode} 
                  setAuthMode={setAuthMode} setView={setView} 
                  setIsUpdatingFromSettings={setIsUpdatingFromSettings} appName={appName} 
                />
              )}
